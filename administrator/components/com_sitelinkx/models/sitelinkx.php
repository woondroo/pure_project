 ...
 */
class SitelinkxModelSitelinkx extends JModel{
	/**
	...
	public function &getData(){
      ...
      $abfr = "SELECT * FROM `#__sitelinkx_config`";
      $daba->setQuery($abfr);
      $erge = $daba->loadObjectList();

			$this->_data = new stdClass();
			$this->_data->id = 0;
			$this->_data->wort = null;
			$this->_data->ersatz = "http://";
			$this->_data->schlagwort = "";
			$this->_data->fenster = $erge[0]->fenster;
			$this->_data->published = $erge[0]->erreichb;
			$derz =& JFactory::getDate()->toFormat();			
			$this->_data->begpub = $derz;
			$this->_data->endpub = "0000-00-00 00:00:00";
			$this->_data->anzahl = $erge[0]->anzahl;
			$this->_data->suchm = $erge[0]->suchm;      			
		}
		return $this->_data;
...
// mcm code 
		...
		$data['anzahl'] = JRequest::getVar('anzahl', '', 'post', 'int');
		$data['suchm'] = JRequest::getVar('suchm', '', 'post', 'int');
// mcm code 
