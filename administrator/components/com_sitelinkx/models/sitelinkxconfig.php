 ...
 */
class SitelinkxModelSitelinkxconfig extends JModel{
	/**
	...
	public function &getData(){
		// Load the data
		if (empty( $this->_data )) {
			$query = 'SELECT * FROM `#__sitelinkx_config` WHERE `id` = 1';
...
// mcm code 
		...
		// $data['version'] = JRequest::getVar('version', '', 'post', 'double');
		$data['anzahl'] = JRequest::getVar('anzahl', '', 'post', 'int');
		$data['suchm'] = JRequest::getVar('suchm', '', 'post', 'int');
		$data['erreichb'] = JRequest::getVar('erreichb', '', 'post', 'int');
		$data['hinweis'] = JRequest::getVar('hinweis', '', 'post', 'int');
// mcm code 
