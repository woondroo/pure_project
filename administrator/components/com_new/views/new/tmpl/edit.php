...
?>
<form action='<?php echo JRoute::_('index.php?option=com_new&layout=edit&id='.(int) $this->item->id); ?>' method='post' name='adminForm' id='new-form' class='form-validate'>
<?php
/**
...
?>
	<div class='width-60 fltlft'>
		<fieldset class='adminform'>
			<legend><?php echo JText::_( 'COM_NEW_NEW_DETAILS' ); ?></legend>
...
?>
	...
	<div class='width-40 fltrt'>
		<?php echo JHtml::_('sliders.start', 'new-slider'); ?>
...
<?php endforeach; ?>
	...
	<div>
		<input type='hidden' name='task' value='new.edit' />
