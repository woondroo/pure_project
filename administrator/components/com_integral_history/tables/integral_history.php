 ...
 * Hello Table class
 */
class Integral_historyTableIntegral_history extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__integral_history', 'id', $db);
	}
	/**
...
//		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_integral_history.message.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId()
	{
		...
		$asset->loadByName('com_integral_history');
		return $asset->id;
	}
}