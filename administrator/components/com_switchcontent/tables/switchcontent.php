 ...
 * Hello Table class
 */
class SwitchcontentTableSwitchcontent extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__switchcontent', 'id', $db);
	...
	{
		$k = $this->_tbl_key;
		return 'com_switchcontent.message.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId()
	{
		...
		$asset->loadByName('com_switchcontent');
		return $asset->id;
	}
}