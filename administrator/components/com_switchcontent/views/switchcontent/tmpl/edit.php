...
?>
<form action='<?php echo JRoute::_('index.php?option=com_switchcontent&layout=edit&id='.(int) $this->item->id); ?>' method='post' name='adminForm' id='switchcontent-form' class='form-validate'>
<?php
/**
...
?>
	<div class='width-60 fltlft'>
		<fieldset class='adminform'>
			<legend><?php echo JText::_( 'COM_SWITCHCONTENT_SWITCHCONTENT_DETAILS' ); ?></legend>
...
?>
	...
	<div class='width-40 fltrt'>
		<?php echo JHtml::_('sliders.start', 'switchcontent-slider'); ?>
...
<?php endforeach; ?>
	...
	<div>
		<input type='hidden' name='task' value='switchcontent.edit' />
