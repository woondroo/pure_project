		...
		<div class="imgOutline">
			<div class="imgTotal">
				<div class="imgBorder center">
					<a class="img-preview" href="<?php echo COM_MEDIA_BASEURL.'/'.$this->_tmp_img->path_relative; ?>" title="<?php echo $this->_tmp_img->name; ?>" style="display: block; width: 100%; height: 100%;background:url(<?php echo str_replace('/administrator','',JURI::base()).$thumb_path; ?>) center center no-repeat;">
					</a>
				</div>
			</div>
			<div class="controls">
