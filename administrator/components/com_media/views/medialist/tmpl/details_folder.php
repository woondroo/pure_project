...
?>
		<tr>
			<td class="imgTotal">
				<a style="background:url(<?php echo str_replace('/administrator','',JURI::base()).'media/media/images/folder_sm.png'; ?>) center center no-repeat;" href="index.php?option=com_media&amp;view=mediaList&amp;tmpl=component&amp;folder=<?php echo $this->_tmp_folder->path_relative; ?>" target="folderframe">
				</a>
			</td>
