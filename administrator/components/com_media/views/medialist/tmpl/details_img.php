...
?>
		<tr>
			<td class="imgTotal">
				<a class="img-preview" style="background:url(<?php echo str_replace('/administrator','',JURI::base()).$thumb_path; ?>) center center no-repeat;" href="<?php echo COM_MEDIA_BASEURL.'/'.$this->_tmp_img->path_relative; ?>" title="<?php echo $this->_tmp_img->name; ?>">
				</a>
			</td>
			<td class="description">
				<a class="img-preview" href="<?php echo  COM_MEDIA_BASEURL.'/'.$this->_tmp_img->path_relative; ?>" title="<?php echo $this->_tmp_img->name; ?>" rel="preview"><?php echo $this->escape($this->_tmp_img->title); ?></a>
			</td>
			<td>
