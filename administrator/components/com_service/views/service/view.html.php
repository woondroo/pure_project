...
class ServiceViewService extends JView
{
	...
	public function display($tpl = null) 
	{
		...
		$script = $this->get('Script');
 		...
 		jimport('mulan.mldb');
 		$pros = MulanDBUtil::getObjectlistBySql('select * from #__product where id in('.$item->pros.')');
	...
	protected function addToolBar() 
	{
		...
		$canDo = ServiceHelper::getActions($this->item->id);
		JToolBarHelper::title($isNew ? JText::_('COM_SERVICE_MANAGER_SERVICE_NEW') : JText::_('COM_SERVICE_MANAGER_SERVICE_EDIT'), 'service');
	...
	protected function setDocument() 
	{
		...
		$document->addScript(JURI::root() . "/administrator/components/com_service/views/service/submitbutton.js");
