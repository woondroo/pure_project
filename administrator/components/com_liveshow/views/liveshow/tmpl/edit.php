...
?>
<form action='<?php echo JRoute::_('index.php?option=com_liveshow&layout=edit&id='.(int) $this->item->id); ?>' method='post' name='adminForm' id='liveshow-form' class='form-validate'>
<?php
/**
...
?>
	<div class='width-60 fltlft'>
		<fieldset class='adminform'>
			<legend><?php echo JText::_( 'COM_LIVESHOW_LIVESHOW_DETAILS' ); ?></legend>
...
endforeach; ?>
	...
	<div class='width-40 fltrt'>
		<?php echo JHtml::_('sliders.start', 'liveshow-slider'); ?>
...
<?php endforeach; ?>
	...
	<div>
		<input type='hidden' name='task' value='liveshow.edit' />
