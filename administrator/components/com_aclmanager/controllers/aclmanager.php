 ...
 */
class AclmanagerControllerAclmanager extends JControllerForm
{
	...
	public function getModel($name = 'Aclmanager', $prefix = 'AclmanagerModel', $config = array('ignore_request' => true))
	{
	...
	public function changepublished()
	{
		...
		$this->setRedirect('index.php?option=com_aclmanager&view=aclmanagers');
	}
}
