...
<link href="templates/system/css/113Q.1.0.css" rel="stylesheet" type="text/css" />
...
<?php } ?>
<div class="ap-main">
	<div id="ap-menus" class="selfclear">
		<?php
		/**
		...
		if ($display_menu) {
		?>
		<div id="ap-mainmenu" class="mr20 fluid selfclear">
			<!--begin-->
			<ul>
		...
		<div id="ap-sidemenu" class="dr20">
			...
			-->
			<ul>
				<?php if (($user->authorise('com_installer.manage')) && $adminAcl != 0 && $display_menu) { ?>
				<li <?php if ($ap_task =="admin") { echo "class=\"active\"";}?>><a href="index.php?ap_task=admin"><span><?php echo JText::_( 'TPL_ADMIN' );?></span></a></li><?php } ?>
				<?php if (($user->authorise('com_users.manage')) && $usersAcl != 0 && $display_menu) {?>
				...
				<?php if (($user->authorise('com_templates.manage')) && $templatesAcl != 0 && $display_menu) {?>
	...
	<div id="ap-mainbody">
		...
		<div id="ap-content" class="<?php if(($switchSidebar) && ($showSidebar)){?>ml20<?php } else if($showSidebar) { ?>mr20<?php } ?> <?php if($showSidebar){?>fluid<?php } ?>">	
			<div id="ap-content-inner">	
				<div class="ap-content-header selfclear">
					<?php
					/**
					 * 2012-02-24 wengebin edit
					 */
					if ($display_menu) {
					?>
					<div id="ap-submenu-inner" class="left">
...
<script type="text/javascript" src="templates/system/js/topthis.js"></script>
</body>
</html>