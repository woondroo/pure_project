...
/**
 * 2012-05-04 wengebin Test
 * 
 * About files:
 * 
 * libraries/joomla/ducument/html/renderer/module.php (method render())
 * libraries/joomla/application/module/helper.php (method moduleCache() - cache id create)
 * libraries/joomla/factory.php (method getCache())
 * libraries/joomla/cache/controller.php (method getInstance())
 * libraries/joomla/cache/controller/callback.php (method get())
 * 
 * Test code:
echo '
STOREID:'.$id.';<br/>
