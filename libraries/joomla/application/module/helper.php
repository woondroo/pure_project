...
//echo 'MODULE NAME:'.$name.'<br/>';
	...
	public static function &getModules($position)
	{
		...
		$result		= array();
//echo 'MODULES POSITION:'.$position.'<br/>';
		...
		for ($i = 0; $i < $total; $i++)
		{
			 ...
			 * 2012-05-06 wengebin edit
			 * 
			 * 如果加载到的模块匹配当前需要加载的 position 位置,则加入渲染集合.
			 */
...
//echo 'CLEAN:'.$clean.'; CACHEID:'.$cacheid.';<br/>';
	...
	*/
	public static function moduleCache($module, $moduleparams, $cacheparams)
	{
		...
		/**
		 * 2012-05-04 wengebin edit
		 * 
		 * Test code: var_dump($cacheparams->cachemode);
		 * 			  echo 'CACHEID:'.$cache_itid.'<br/>';
		 */
		$cache_itid	= JRequest::getVar('Itemid',null,'default','INT');
		$catid		= JRequest::getInt('id');
		$pid		= JRequest::getInt('pid', 0);
		$cache_itid .= $catid;
		$cache_itid .= $pid;
//echo 'MODULE:'.$module->module.'; MODID:'.$module->id. $view_levels.$cache_itid.';<br/>';
//echo $cacheparams->cachemode.'<br/>';
//if ($cacheparams->cachemode == 'itemid') {
//	echo $module->id. $view_levels.$cache_itid;echo '<br/><br/>';
//}
		switch ($cacheparams->cachemode) {
			...
			case 'itemid':
			default:
				$ret = $cache->get(array($cacheparams->class, $cacheparams->method), $cacheparams->methodparams, $module->id. $view_levels.$cache_itid, $wrkarounds, $wrkaroundoptions);
				break;
		}
