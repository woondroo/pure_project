...
abstract class JHtmlBehavior
{
	...
	public static function keepalive()
	{
		 ...
		 * 
		 * 删除原有的 mootools 的写法，改为jQuery的写法
		 * 主要因为前台已经删除了 mootools 的核心文件引入，只有jQuery的引入，所以需要改为jQuery
		 */
...
//		$script .=  ');';
		$script .= 'function keepAlive(){$.ajax({type:"GET",url:"index.php"});}';
		$script .= '$(document).ready(function(){setInterval(keepAlive, '.$refreshTime.');});';
