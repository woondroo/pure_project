 ...
 * @since		1.5
 */
class NewViewNew extends JView
{
	protected $state;
	protected $item;
	protected $pre_item;
...
//		$this->next_item	= $this->get('NextOne');
	...
	protected function _prepareDocument()
	{
		...
		$this->params	= $app->getParams('com_new');
		...
		MulanDBUtil::executeSql('update #__new set clicks=clicks+1 where id='.MulanDBUtil::dbQuote($this->item->id));
	}
}
