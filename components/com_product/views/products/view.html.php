...
class ProductViewProducts extends JView
{
	...
	protected function _prepareDocument()
	{
		...
		// If it is the active menu item, then the view and products id will match
		...
		$title = $this->currentCate->ctitle ? $this->currentCate->ctitle : JText::_('COM_PRODUCT_DEFAULT_PAGE_TITLE');
