...
class UsersControllerUser extends UsersController
{
	...
	public function login()
	{
		...
		$languages = array('checkcodeError'=>'验证码错误！');
		if ($pagelanguage == 2) {
			$languages = array('checkcodeError'=>'Verification code error!');
		}
		
		$checkcode = JRequest::getVar('checkcode');
		MulanImageUtil::onCaptcha_confirm($checkcode, &$return);
		if (!$return) {
			JError::raiseWarning('',$languages['checkcodeError']);
