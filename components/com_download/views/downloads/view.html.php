...
class DownloadViewDownloads extends JView
{
	...
	protected function _prepareDocument()
	{
		...
		// If it is the active menu item, then the view and downloads id will match
		...
		$title = $this->currentCate->ctitle ? $this->currentCate->ctitle : JText::_('COM_DOWNLOAD_DEFAULT_PAGE_TITLE');
