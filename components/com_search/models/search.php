...
class SearchModelSearch extends JModel
{
	...
	/**
	 * Method to get search item data for the category
	 *
	 * @access public
	 * @return array
	 */
	function getData()
	{
		...
		if (empty($this->_data))
		{
			...
			$this->setState('limit',12); // 订死每页最多12条
	...
	/**
	 * Method to get the total number of search items for the category
	 *
	 * @access public
	 * @return integer
	 */
	...
	/**
	 * Method to get a pagination object of the search items for the category
	 *
	 * @access public
	 * @return integer
	 */
